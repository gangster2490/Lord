...
@Serializable
enum class ShotStyle { Auto, Showcase, Demo, Lifestyle, Macro, Satisfying, Unboxing }
...
data class Project(
    ...
    val style: ShotStyle = ShotStyle.Auto,
    val tiktokShop: Boolean = true,
...
fun ShotStyle.label(): String = when (this) {
    ShotStyle.Auto -> "Auto"
    ShotStyle.Showcase -> "Showcase"
    ShotStyle.Demo -> "Demo"
...
object StudioRules {
    ...
    fun canGenerate(project: Project): Boolean =
        project.photos.isNotEmpty() && project.status != ProjectStatus.Generating
